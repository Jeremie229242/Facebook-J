...
const Page = () => {
  ...
  const registerSchema = yup.object().shape({
    ...
    gender: yup
      .string()
      .oneOf(["male", "female", "other"], "Merci de selectionner votre sexe ")
  ...
  const onSubmitRegister = async(data) =>{
    try {
       const result = await registerUser(data)
        ...
        toast.success('Utilisateur inscrit avec succes')
    } catch (error) {
      console.error(error);
  ...
  const onSubmitLogin = async(data) =>{
    try {
       const result = await loginUser(data)
        ...
        toast.success('Utilisateur connecter avec succes')
    } catch (error) {
      console.error(error);
        ...
        <Card className="w-full max-w-md dark:text-white">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">
              <span>Facebook-G</span>
            </CardTitle>
            <CardDescription className="text-center">
            Restez en contact avec vos amis et le monde qui vous entoure sur Facebook.
            </CardDescription>
          </CardHeader>
            ...
            <Tabs defaultValue="login" className="w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="Entrer votre Passe"
                        className="col-span-3 dark:border-gray-400"
                      />
                    ...
                    <Button className="w-full" type="submit">
                      <LogIn className="mr-2 w-4 h-4" /> Se connecter
                    </Button>
                  </div>
                </form>
              </TabsContent>
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSubmitSignUp(onSubmitRegister)}>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="signupName">Nom d'utilisateur</Label>
                      <Input
                        id="signupName"
                        name="username"
                        type="text"
                    ...
                    <Button className="w-full" type="submit">
                      <LogIn className="mr-2 w-4 h-4" /> Soummettre
                    </Button>
                  </div>
                </form>
              </TabsContent>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="relative w-full">
                 ...
                 <div className="relative flex justify-center text-xs uppercase">
                    <span className=" px-2 text-muted-foreground">Ou continuer sur</span>
                 </div>
            </div>
