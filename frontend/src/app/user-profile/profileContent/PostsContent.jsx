    ...
    <Card>
        <CardContent className="p-6  dark:text-white ">
            ...
            <div >
                  ...
                  <p className='font-sm text-gray-500'> {formatDistanceToNow(new Date(post?.createdAt), { addSuffix: true, locale: fr })}</p>
            </div>
                </div>
             ...
             <div className='flex justify-between items-center mb-4'>
                ...
                <span className='text-sm text-gray-500 dark:text-gray-400 hover:border-b-2 border-gray-400 cursor-pointer ' onClick={() => setShowComments(!showComments)}>{post?.commentCount}  commentaires</span>
                <span className='text-sm text-gray-500 dark:text-gray-400 hover:border-b-2 border-gray-400 cursor-pointer '>{post?.shareCount}  Partage</span>
                </div>
             </div>
                     ...
                     <Dialog open={isShareDialogOpen} onOpenChange={setIsShareDialogOpen}>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>Choisissez comment vous souhaitez partager cette publication</DialogDescription>
                            </DialogHeader>
                            <div className='flex flex-col space-y-4 '>
                                 <Button onClick= {() => handleShare('facebook')}>Partager sur Facebook</Button>
                                 <Button onClick= {() => handleShare('twitter')}>Partager sur Twitter</Button>
                                 <Button onClick= {() => handleShare('linkedin')}>Partager sur Linkedin</Button>
                                 <Button onClick= {() => handleShare('copy')}>Copie le liens</Button>
                            </div>
                        </DialogContent>
                     </Dialog>
             </div>
