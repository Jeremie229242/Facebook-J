...
const ProfileDetails = ({
  ...
  const handleLike = async (postId) => {
    ...
    if (updatedLikePost.has(postId)) {
      ...
      toast.error("publication désapprouvée avec succès");
    } else {
      updatedLikePost.add(postId);
      toast.success("publier comme réussi");
    }
    ...
    try {
      ...
      console.error(error);
      toast.error("Impossible d'aimer ou de ne pas aimer la publication");
    }
  };
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="flex items-center mb-4 dark:text-gray-300">
                ...
                <span>Suivi par {profileData?.followingCount} personnes</span>
              </div>
              {isOwner && (
                <Button
                  className="w-full "
    ...
    about: (
      ...
      >
        <Card>
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold mb-4 dark:text-gray-300">
              Apropos de {" "} {profileData?.username}
            </h2>
            <div className="space-y-4 dark:text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span>Date de naissance: {formatDateInDDMMYYY( profileData?.dateOfBirth)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
